"""
Django settings for testuserapp_44136 project.
...
ROOT_URLCONF = 'testuserapp_44136.urls'
...
WSGI_APPLICATION = 'testuserapp_44136.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testuserapp_44136 API",
    "DESCRIPTION": "API documentation for testuserapp_44136 App",
    "VERSION": "v1",
}
